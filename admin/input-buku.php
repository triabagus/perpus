                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="pengarang" class="form-control" id="pengarang" type="text" placeholder="Pengarang Buku" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tahun Terbit</label>
                              <div class="col-sm-8">
                                  <input name="th_terbit" class="form-control" id="th_terbit" type="text" placeholder="Tahun Terbit Buku" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="penerbit" class="form-control" id="penerbit" type="text" placeholder="Penerbit Buku" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Isbn</label>
                              <div class="col-sm-8">
                                  <input name="isbn" type="text" id="isbn" class="form-control" placeholder="Ex : QWERT122345566" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="kategori" type="text" id="kategori" class="form-control" placeholder="Ex : 1300" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="lokasi" class="form-control" id="lokasi" type="text" placeholder="Lokasi Buku" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Asal</label>
                              <div class="col-sm-8">
                                  <input name="asal" class="form-control" id="asal" type="text" placeholder="Asal Buku" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jum temp</label>
                              <div class="col-sm-8">
                                  <input name="jum_temp" class="form-control" id="jum_temp" type="text" placeholder="Jum_temp" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tgl Input</label>
                              <div class="col-sm-8">
                                  <input name="tgl_input" class="form-control" id="tgl_input" type="date" placeholder="Tanggal peminjaman" required />
                              </div>
                          </div>
                          <div class="form-group">
