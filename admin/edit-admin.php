...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-admin.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">User ID</label>
                              <div class="col-sm-8">
                                  <input name="user_id" type="text" id="user_id" class="form-control" placeholder="Tidak perlu di isi" value="<?php echo $data['user_id']; ?>" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="fullname" type="text" id="fullname" class="form-control" placeholder="Fullname" value="<?php echo $data['fullname']; ?>" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <img src="<?php echo $data['gambar']; ?>" height="250" width="250" alt="Foto Admin" style="margin-bottom: 10px;" /><br />
