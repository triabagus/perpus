...
<?php } ?>
                ...
                <section class="content">
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <form action="admin.php" method="POST">
                                        <div class="input-group">
                                        <input type='text' class="form-control input-sm pull-right" style="width: 150px;"  name='qcari' placeholder='Cari berdasarkan username & user id' required /> 
                  ...
                  <thead>
                    ...
                    <td><a href="detail-admin.php?hal=edit&kd=<?php echo $data['user_id'];?>"><span class="fa fa-user"></span>    <?php echo $data['username']; ?></a></td>
                    ...
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['username'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Admin" href="hapus-admin.php?hal=admin&kd=<?php echo $data['user_id'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
                  ...
                  <?php $tampil=mysql_query("select * from admin order by user_id");
                    ...
                    ?>
                  <center><h4>Jumlah admin: <?php echo "$user"; ?> Orang </h4> </center>
